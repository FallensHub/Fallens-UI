...
Fallens.Colors = {
	Highlight = Color3.fromRGB(132, 89, 249),
	Toggle = Color3.fromRGB(132, 89, 249),
	Risky = Color3.fromRGB(255, 90, 90),
	BGDBColor = Color3.fromRGB(15, 15, 18),
	BlockColor = Color3.fromRGB(20, 20, 24),
	StrokeColor = Color3.fromRGB(34, 34, 39),
	SwitchColor = Color3.fromRGB(255, 255, 255),
	DropColor = Color3.fromRGB(22, 22, 26),
	MouseEnter = Color3.fromRGB(38, 38, 44),
	BlockBackground = Color3.fromRGB(24, 24, 28),
	LineColor = Color3.fromRGB(42, 42, 48),
