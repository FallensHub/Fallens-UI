...
local Compkiller = {
	...
	Scale = {
		...
		Small = UDim2.new(0, 380,0, 460),
		Medium = UDim2.new(0, 485,0, 565),
		Large = UDim2.new(0, 620,0, 700),
		PC = UDim2.new(0, 485,0, 565),
	...
	do
		...
		function WindowArgs.UserSettings:Create()
			...
			local ScalePresets = {
				...
				["Medium"] = Compkiller.Scale.Medium,
				["Large"] = Compkiller.Scale.Large,
				["Mobile"] = Compkiller.Scale.Mobile,
				["PC"] = Compkiller.Scale.PC,
			};

			local CurrentScaleName = (Compkiller:_IsMobile() and "Mobile") or "Medium";

			SettingsAPI:AddDropdown({
				Name = "Menu Scale",
				Default = CurrentScaleName,
				Values = {"Small","Medium","Large","Mobile","PC"},
				Multi = false,
